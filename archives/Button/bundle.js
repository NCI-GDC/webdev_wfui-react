...
ReactDOM.render( 
    <WFUIJS.RCT.Button_1 data={{ title: "button", is_primary: true }}/>, document.getElementById('button2')
);
ReactDOM.render( 
    <WFUIJS.RCT.Button_1 data={{ title: "button", is_header_link: true }}/>, document.getElementById('button3')
);
ReactDOM.render( 
