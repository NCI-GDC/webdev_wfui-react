...
class InputField extends Component {
  ...
  render() {
    ...
    var inputFieldElement = hideField ? "" :
          <span>
            {prefixField}
              <input className={"wfui-input-field__input"+ errorClassName} type={type} defaultValue={defaultValue} value={value} placeholder={placeholder} name={name} onHandleFocus={this.onHandleFocus.bind(this)} onChange={this.onHandleChange.bind(this)} onClick={this.onHandleClick.bind(this)} onBlur={this.onHandleBlur.bind(this)} disabled={preview} maxLength={maxLength} min={min} max={max} />
              {postfixField}
          </span>;
    return (
