...
ReactDOM.render( <InputField type="text" name="input1" errors={true} label="Type Text:" />, document.getElementById('input1'));
ReactDOM.render( <InputField type="email" name="input2" label="Type Email:" />, document.getElementById('input2'));
ReactDOM.render( <InputField type="number" name="input3" errors={1} label="Type Number:" />, document.getElementById('input3'));
