    ...
    render() {
        ...
        return (
            <div className={classNames(className, 'wfui-form-item', { 'wfui-form-item-error': globalError })}>
                ...
                <FormGroup className={`wfui-table-format multiple-inputs-${Object.keys(fieldMap).length}`} validationState={allTouched && globalError ? 'error' : null}>
                    ...
                    {Object.keys(fieldMap).map((key, i) => {
                        ...
                        if (Object.keys(fieldMap).length - 1 > i) {
                            lists.push(<li className="wfui-input-table__li"><span className="wfui-input-table__condition">{logic}</span></li>);
                        }
                        return lists;
                    })}
                    </ul>
