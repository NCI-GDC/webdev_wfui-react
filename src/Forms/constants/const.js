...
CaG.SurveyConst = function(){
    function get(key){ return constants[key]; }
    var constants = {
        survey_form_nid: 90,
...
//Error Messages
const getErrorMessages = (code, vals)=>{
    switch(code.toString()){
        //Common
        case E.ERR_MISSING_VALUES: return i18n("Please fill out every field in the table");
        case E.ERR_OUT_OF_RANGE: return i18n("The number has to be in the range") + " ( " + (vals.min? i18n("from") + " " + vals.min + " " : "" ) + (vals.max ? i18n("to") + " " + vals.max : "") + " )";
        case E.ERR_MISSING_OTHER: return i18n("Please fill out a value for this input field");
    }
}

export default Object.assign(APIs, E, {getErrorMessages});