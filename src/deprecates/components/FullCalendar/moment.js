...
let defaultLocaleMonthsShort = 'Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec'.split('_');
    ...
    let i; var ii; var mom; var llc = monthName.toLocaleLowerCase();
...
let defaultLocaleWeekdays = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split('_');
    ...
    let i; var ii; var mom; var llc = weekdayName.toLocaleLowerCase();
    ...
    let minPieces = []; var shortPieces = []; var longPieces = []; var mixedPieces = [];
    ...
    let i = 0; var j; var next; var locale; var split;
    ...
    function updateLocale(name, config) {
        if (config != null) {
        let locale; var parentConfig = baseConfig;
            // MERGE
            if (locales[name] != null) {
                parentConfig = locales[name]._config;
            }
...
let years        = makeGetter('years');
    ...
    let a = seconds < thresholds.s && ['s', seconds]  ||
            (minutes <= 1 && ['m']) ||
