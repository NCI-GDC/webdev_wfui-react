                ...
                if (
                    ...
                    if (
                        ...
                        if ((!g && c.which != 27) || (g && c.which == 27))
                            return (
                                c.which == 27 && e.find(f).trigger('focus'),
                                d.trigger('click')
                            );
    ...
    +(function(a) {
        ...
        (c.VERSION = '3.3.7'),
            ...
            (c.prototype.init = function(b, c, d) {
                ...
                for (
                    let e = this.options.trigger.split(' '), f = e.length;
                    f--;
            ...
            (c.prototype.getViewportAdjustedDelta = function(a, b, c, d) {
                ...
                const f =
                    (this.options.viewport && this.options.viewport.padding) ||
                    0;
    ...
    +(function(a) {
        ...
        (b.VERSION = '3.3.7'),
            ...
            (b.prototype.process = function() {
                ...
                const d =
                    this.options.offset + c - this.$scrollElement.height();
            ...
            (c.prototype.checkPosition = function() {
                if (this.$element.is(':visible')) {
                    ...
                    if (this.affixed != h) {
                        ...
                        (this.affixed = h),
                            (this.unpin =
                                h == 'bottom' ? this.getPinnedOffset() : null),
                            this.$element
                                .removeClass(c.RESET)
                                .addClass(i)
                                .trigger(
