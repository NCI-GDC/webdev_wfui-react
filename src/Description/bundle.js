...
ReactDOM.render( <Description content={htmlText2} type="theme-purple" imageSrc="reg.png" imageDescription="" />, document.getElementById('description3'));
...
ReactDOM.render( <Description content={element3} type="theme-purple" imageSrc="wawdwda/awd" imageDescription="This is the image aboveThis is the image aboveThis is the image aboveThis is the image aboveThis is the image aboveThis is the image aboveThis is the image aboveThis is the image aboveThis is the image above" />, document.getElementById('description5'));