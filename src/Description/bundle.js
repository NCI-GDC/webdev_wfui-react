...
var htmlText2 = (
	"<div style='width:600px; border:none; background-color:#FDDCD9; padding:10px;'><b>Before you begin:</b><br><ol><li>Adjust your scale to zero;</li><li>Weigh yourself with your clothes off, or wear light clothing. Remember to remove your shoes;</li><li>Step on the scale. Make sure both feet are fully on the scale.</li></ol></div>"
);
...
ReactDOM.render( <Description content={htmlText2} />, document.getElementById('description4'));