...
class FilteredListContainer extends React.Component {
    ...
    render() {
        const { numOfItems, numTotal, starting, last, rawData } = this.state;
        console.log(rawData);
        return (
            <div>
                <FilteredList
                    ...
                    onDisplay={({ starting, last, numListed, numTotal, rawData }) => { this.setState({ starting, last, numListed, numTotal, rawData }) }}
