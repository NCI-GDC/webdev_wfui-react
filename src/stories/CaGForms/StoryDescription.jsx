...
class Example extends React.Component {
	render() {
		return (
			<div>
				<Description content="simple text description" src="test.png" imageTitle={"imageTitle"} />
				<Description type="theme-blue" classNames="extra-lalalalla awdawd"></Description>
				<Description content={htmlText2} errors={1} type="theme-purple" imageDescription="" />
				<Description content={element1} type="theme-red" />
				<Description content={element3} type="theme-purple"><img src="icon-cancer-types.svg" title="This is the image above" /></Description>
			</div>
		)
	}
}
