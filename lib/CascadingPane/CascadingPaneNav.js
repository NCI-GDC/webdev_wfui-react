        ...
        value: function render() {
            ...
            if (logoField) {
                navFormat.push({
                    ...
                    display: function display(item) {
                        return _react2.default.createElement('img', { role: 'presentation', src: item[logoField], className: 'cascadin-nav-logo' });
                    }
                });
            }
            navFormat.push({
            ...
            if (itemConfigDisplay) {
                navFormat.push({
                    ...
                    display: function display(item) {
                        return _react2.default.cloneElement(itemConfigDisplay, Object.assign({}, item, { updateNav: function updateNav() {
