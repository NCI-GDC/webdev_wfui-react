    ...
    _createClass(CascadingPaneSubView, [{
        ...
        value: function render() {
            var _props3 = this.props,
                ...
                _reloadMainView = _props3.reloadMainView,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        fetchedSub && fetchedMain && _react2.default.cloneElement(contentDisplay, {
                            ...
                            data: data,
                            reloadMainView: function reloadMainView() {
                                return _reloadMainView(config);
                            },
                            reloadSubView: function reloadSubView() {
                                return getCascadingSubView(config);
                            },
                            navSelect: navSelect,
