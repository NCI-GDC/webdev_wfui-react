...
var renderTableFormat = _wfuiReact.FormFields.renderTableFormat;
    ...
    _createClass(TypeTableFormat, [{
        ...
        value: function render() {
            ...
            var props = {
                ...
                description: _react2.default.createElement(_wfuiReact.Description, { content: data.description, src: data.image && data.image.src, imageTitle: data.image && data.image.title })
            };
