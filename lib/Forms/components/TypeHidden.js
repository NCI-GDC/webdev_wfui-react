...
var TypeHidden = function (_React$Component) {
    _inherits(TypeHidden, _React$Component);

    function TypeHidden() {
        _classCallCheck(this, TypeHidden);

        return _possibleConstructorReturn(this, (TypeHidden.__proto__ || Object.getPrototypeOf(TypeHidden)).apply(this, arguments));
    }

    _createClass(TypeHidden, [{
        key: 'render',
...
var TypeHiddenContainer = (0, _reactRedux.connect)(function (state, props) {
...
exports.default = TypeHiddenContainer;