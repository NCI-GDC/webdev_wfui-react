...
var TypeFilterTable = function (_React$Component) {
    ...
    function TypeFilterTable() {
        ...
        var _this = _possibleConstructorReturn(this, (TypeFilterTable.__proto__ || Object.getPrototypeOf(TypeFilterTable)).call(this));

        _this.state = { valueChanged: 0 };
        return _this;
    }
    ...
    _createClass(TypeFilterTable, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (!(0, _deepEqual2.default)(this.props.values, nextProps.values)) {
        ...
        value: function render() {
            ...
            var valueChanged = this.state.valueChanged;
...
var TypeFilterTableContainer = (0, _reactRedux.connect)(function (state, props) {
    ...
    return {
        syncErrors: syncErrors || {},
        values: (0, _reduxForm.getFormValues)(formID)(state)
    };
})(TypeFilterTable);
