...
var WebForm = function (_React$Component) {
    ...
    function WebForm(props) {
        ...
        _this.state = { surveyDataState: [], translated: false, activeId: props.activeId };
    ...
    _createClass(WebForm, [{
        ...
        value: function componentWillMount() {
            ...
            if (!loggedin) {
                surveyDataState[survey_data.length - 1].children = _const.anonymousFormFields.concat(surveyDataState[survey_data.length - 1].children);
            }
        ...
        value: function saveSubmission(callback) {
            ...
            saveSubmission(survey_info.nid, sectionId, language, loggedin, getConfig).then(callback);
        }
    }, {
        key: 'next',
            ...
            if (surveyDataState) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        surveyDataState.length > 1 && _react2.default.createElement(_SideBar2.default, _extends({}, this.props, { activeId: activeId, translated: translated })),
                        _react2.default.createElement(
                            'div',
