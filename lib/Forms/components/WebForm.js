...
var WebForm = function (_React$Component) {
    ...
    function WebForm(props) {
        ...
        _this.state = { translated: false, activeId: props.activeId };
    ...
    _createClass(WebForm, [{
        ...
        value: function saveSubmission(callback) {
            var _props2 = this.props,
                ...
                survey_info = _props2.survey_info,
                saveSubmission = _props2.saveSubmission,
                getConfig = _props2.getConfig;
            var activeId = this.state.activeId;
            ...
            saveSubmission(survey_info.nid, sectionId, language, getConfig).then(callback);
        }
    }, {
        key: 'next',
        ...
        value: function _submit() {
            var _props4 = this.props,
                nid = _props4.nid,
                allowPublish = _props4.allowPublish,
                dispatch = _props4.dispatch,
                submitSubmission = _props4.submitSubmission;
            // dispatch(setInActionState(true));
        ...
        value: function render() {
            var _props5 = this.props,
                displaySubmit = _props5.displaySubmit,
                survey_data = _props5.survey_data,
                in_action = _props5.in_action,
                submissions = _props5.submissions,
                recaptchaSiteKey = _props5.recaptchaSiteKey,
                loggedin = _props5.loggedin;
            ...
            if (survey_data) {
                return _react2.default.createElement(
                    'div',
                    { className: 'application-app ' + (survey_data.length > 1 ? 'multi-section' : 'single-section') },
                    _react2.default.createElement(
                        ...
                        in_action ? _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'p',
                                { className: 'page_loading', style: { opacity: 0.5 } },
                                _react2.default.createElement('i', { className: 'fa fa-spinner fa-spin' })
                            )
                        ) : "",
                        survey_data.length > 1 && _react2.default.createElement(_SideBar2.default, _extends({}, this.props, { activeId: activeId, translated: translated })),
                        _react2.default.createElement(
                            'div',
                            { className: 'application-main section-' + activeId },
                            _react2.default.createElement(
                                _reactAddonsCssTransitionGroup2.default,
                                { transitionAppear: true, transitionName: 'fade', transitionEnterTimeout: 500, transitionLeaveTimeout: 500, transitionAppearTimeout: 500 },
                                _react2.default.createElement(
                                    'div',
                                    { className: 'row' },
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'default_slide', style: sliderStyle },
                        ...
                        _react2.default.createElement(_SubmitConfirmDialog2.default, { ref: 'submit_conform_dialog', onHandleSubmit: this._submit.bind(this) }),
