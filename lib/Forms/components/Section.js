...
var renderField = _wfuiReact.FormFields.renderField,
    renderTextArea = _wfuiReact.FormFields.renderTextArea,
    renderAddAnother = _wfuiReact.FormFields.renderAddAnother,
    renderRadios = _wfuiReact.FormFields.renderRadios,
    renderCheckboxs = _wfuiReact.FormFields.renderCheckboxs,
    renderSelect = _wfuiReact.FormFields.renderSelect;
            ...
            if (isActive) {
                if (index && allowPrev) {
                    prev = _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            { href: '#', id: index, onClick: this.onClickPrev.bind(this) },
                ...
                if (index != this.context.last) {
                    next = _react2.default.createElement(
                        _index.Button,
                        { disabled: saving, className: 'btn-survey-submit survey-trigger', id: index, onClick: handleSubmit(this.onHandleSubmit) },
                        i18n('Continue')
                    );
                } else if (!loggedin) {
                    ...
                    next = _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _index.Button,
                            { disabled: saving || !grecaptchaState, className: 'btn-survey-submit survey-trigger', id: index, onClick: handleSubmit(this.onHandleSubmit) },
                            _react2.default.createElement(
                                'span',
