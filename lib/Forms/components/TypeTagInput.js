...
exports.TypeTagInputPreview = undefined;
...
var TypeTagInput = function (_React$Component) {
    _inherits(TypeTagInput, _React$Component);

    function TypeTagInput() {
        _classCallCheck(this, TypeTagInput);

        return _possibleConstructorReturn(this, (TypeTagInput.__proto__ || Object.getPrototypeOf(TypeTagInput)).apply(this, arguments));
    }

    _createClass(TypeTagInput, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_reduxForm.Field, {
                    ...
                    type: 'text',
                    component: _FormFields.renderTags,
...
var TypeTagInputContainer = (0, _reactRedux.connect)(function (state, props) {
...
exports.default = TypeTagInputContainer;

/**
 * Preview Component
 */

var TypeTagInputPreview = exports.TypeTagInputPreview = (0, _reduxForm.reduxForm)({
    form: 'form_preview',
