    ...
    _createClass(WFUIDropdown, [{
        ...
        value: function renderMenu(child, _ref) {
            ...
            return (0, _react.cloneElement)(child, _extends({}, props, {
                ...
                onSelect: (0, _createChainedFunction2.default)(child.props.onSelect, onSelect, function (key, event) {
                    return _this4.handleClose(event, { source: 'select' });
                }),
                rootCloseEvent: rootCloseEvent
            }));
        }
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                ...
                props = _objectWithoutProperties(_props2, ['componentClass', 'id', 'dropup', 'disabled', 'pullRight', 'onSelect', 'role', 'bsClass', 'className', 'rootCloseEvent', 'children']);
            ...
            return _react2.default.createElement(
                ...
                _ValidComponentChildren2.default.map(children, function (child) {
                    switch (child.props.bsRole) {
                        case TOGGLE_ROLE:
                            return _this6.renderToggle(child, {
                                id: id,
                                disabled: disabled,
                                open: open,
                                role: role,
...
var UncontrolledDropdown = (0, _uncontrollable2.default)(WFUIDropdown, { open: 'onToggle' });
