...
var propTypes = {
    ...
    forcePosition: _propTypes2.default.string
};
...
var WFUIDropdown = function (_React$Component) {
    ...
    _createClass(WFUIDropdown, [{
        ...
        value: function onShow(e) {
            ...
            var forcePosition = this.props.forcePosition;
            var uid = this.state.uid;
            ...
            if (el) {
                ...
                var scrollTopOffset = window.scrollY || window.pageYOffset || document.body.scrollTop + (document.documentElement && document.documentElement.scrollTop || 0);
                ...
                _reactDom2.default.render(this.getMenu(), el, function () {
                    ...
                    if (el && el.getAttribute('class') === 'menu-opened') {
                        ...
                        if (forcePosition !== 'left' && (window.innerWidth < dropdown.getBoundingClientRect().right || forcePosition === 'right')) {
