...
var renderTags = function (_React$Component) {
    ...
    function renderTags(props) {
        ...
        _this.state = {
            tags: _this.transformSubmissionToForm(props.initialValues || []),
    ...
    _createClass(renderTags, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                withContent = _props.withContent,
            ...
            var Comp = withContent ? _reactTagInput.WithContext : _reactTagInput.WithOutContext;
