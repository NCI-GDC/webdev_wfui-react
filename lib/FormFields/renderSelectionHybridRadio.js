    ...
    _createClass(renderSelectionHybridRadio, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                {
                    className: (0, _classnames2.default)(className, 'wfui-form-item', { 'wfui-form-item-error': (allTouched || showErrors) && globalError }, { 'wfui-form-disabled': disabled }, { 'wfui-form-preview': preview }, { 'wfui-form-item-full-width': fullWidth })
                },
                ...
                _react2.default.createElement(
                    _index.FormGroup,
                    {
                        className: 'wfui-form-field ' + (descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description') + ' wfui-radios-hybrid column-count-' + columnCount,
                    ...
                    options.map(function (option, i) {
                        ...
                        var renderRadio = _react2.default.createElement(
                            ...
                            {
                                key: i,
                                className: (radioProps.input.value === _key ? 'active' : '') + ' ' + (fieldMap[_key] ? 'radio-with-radioHybrid' : ''),
                                name: name + '.' + radioCid,
                                value: _key,
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        ' ',
                        (allTouched || showErrors) && globalError && _react2.default.createElement(
                            'span',
                            null,
                            globalError
                        ),
