...
var renderSelect = function renderSelect(_ref) {
  ...
  return React.createElement(Form.Row, {
    ...
    className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-select") // validationState={(touched || showErrors) && (error || globalError) ? 'error' : null}
