...
var _input_hybrid = require('../Forms/helpers/input_hybrid');
...
var renderFilterTable = function (_React$Component) {
    ...
    _createClass(renderFilterTable, [{
                ...
                return {
                    ...
                    display: function display(data) {
                        ...
                        if (values) {
                            switch (q.type) {
                                case 'listbox':
                                    return (0, _input_hybrid.getValByKey)(values.listbox, q.values[lang].options);
                                case 'input-hybrid':
        ...
        value: function generateFilterUI() {
            ...
            filters.push(_react2.default.createElement(
                ...
                questions.filter(function (question) {
                    ...
                    var cid = field ? field.cid : 'listbox';
                    return _react2.default.createElement(
                        'select',
                        { key: i, 'data-name': question.id + '.' + cid, onChange: _this3.onFilterChange },
                        _react2.default.createElement(
                            'option',
                            { value: '' },
                            '-- Filter by ',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)(className, 'wfui-form-item', { 'wfui-form-item-error': error }, { inactive: fields.length >= 0 }) },
                _react2.default.createElement(
                    _index.ControlLabel,
                    null,
                    label
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _index.Button,
                            { bsStyle: 'default', className: 'btn-add-col add-btn', onClick: this.onHandleAdd },
                            labelAddAnother
                        )
                    ),
                    _react2.default.createElement(
