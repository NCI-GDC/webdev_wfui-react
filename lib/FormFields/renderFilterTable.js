  ...
  _createClass(renderFilterTable, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "col-h4"
      }, "Your ".concat(labelItem, " (").concat(fields.length, ")")), React.createElement("div", {
        className: "col-header-btn-container"
      ...
      }, React.createElement("span", null, Array.isArray(error) ? error.join(', ') : error)), help && React.createElement("div", {
