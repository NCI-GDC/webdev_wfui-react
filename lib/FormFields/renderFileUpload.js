  ...
  _createClass(renderFileUpload, [{
    ...
    value: function renderFile() {
      ...
      if (input.value && Object.keys(input.value).length) {
        ...
        return React.createElement("div", {
          ...
          className: "btn btn-default ".concat(review ? 'review-page' : '', " ").concat(this.getFileKey(input.value.type)),
          type: "button",
          href: src,
          target: "_blank"
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "filetypes"
      }, allowedExtensionText.replace('{fileTypes}', fileTypes.join(', ')))), fileError && React.createElement(HelpBlock, {
        className: "wfui-form-error"
      }, React.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: fileError
        }
      })), touched && globalError && React.createElement(HelpBlock, {
        className: "wfui-form-error"
