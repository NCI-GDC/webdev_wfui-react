    ...
    _createClass(renderFileUpload, [{
        ...
        value: function renderFile() {
            ...
            if (input.value && Object.keys(input.value).length) {
                var filePath = input.value.id ? fileDownloadPath.replace(':id', input.value.id) : input.value.blobPath;
                ...
                if (input.value.type && input.value.type.indexOf('image') === 0) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('img', { src: filePath, alt: input.value.name, width: '150' })
                        ),
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                ...
                attrs = _props3.attrs,
                descDisplay = _props3.descDisplay,
            ...
            return _react2.default.createElement(
                'div',
                {
                    className: (0, _classnames2.default)(className, 'wfui-form-item', { 'wfui-form-item-error': globalError }, { 'wfui-form-disabled': disabled }, { 'wfui-form-preview': preview }, { 'wfui-form-item-full-width': fullWidth })
                },
                _react2.default.createElement(
                    'div',
