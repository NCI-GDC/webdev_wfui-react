...
var renderFileUpload = function (_React$Component) {
    ...
    _createClass(renderFileUpload, [{
        ...
        value: function setFile(props) {
            ...
            } else if (input.value.blobPath || input.value.data) {
                ...
                if (input.value.type && input.value.type.indexOf('image') === 0) {
                    return _react2.default.createElement(
                        ...
                        src ? _react2.default.createElement(
                            ...
                            _react2.default.createElement('img', { src: src, alt: input.value.name, width: '150' })
        ...
        value: function renderChildComponets() {
            ...
            var child = [_react2.default.createElement(
                'div',
                { className: 'input-group', style: { position: 'relative' }, key: 'input-group' },
        ...
        value: function renderDropzone() {
            ...
            var _state3 = this.state,
                ...
                initialValue = _state3.initialValue;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'p',
                        { className: 'wfui-form-file-upload-spec', key: 'wfui-form-file-upload-spec' },
                        _react2.default.createElement(
                            'span',
                            { className: 'filesize' },
