...
import { FormControl, FormGroup, ControlLabel, HelpBlock, Form, Col, Button } from '../index';
  ...
  _createClass(renderFileUpload, [{
      ...
      return React.createElement(Dropzone, _extends({
        ...
        onDrop: function onDrop(acceptedFiles, rejectedFiles) {
          if (acceptedFiles.length > 0) {
            ...
            if (accept.length && !accept.includes(rejectedFiles[0].type)) {
              _this4.setState({
    ...
    value: function render() {
      var _this$props7 = this.props,
          ...
          showErrors = _this$props7.showErrors;
      var _this$state3 = this.state,
          fileError = _this$state3.fileError,
      ...
      return React.createElement(Form.Row, {
        ...
        className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-file-upload") // validationState={
      ...
      })), (touched || showErrors) && globalError && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error",
        type: "invalid"
...
renderFileUpload.defaultProps = {
  ...
  mimeTypes: {
    ...
    gif: ['image/gif'],
    svg: ['image/svg+xml'],
    ico: ['image/vnd.microsoft.icon', 'image/x-icon', 'application/ico', 'image/ico']
  },
  fileDownloadPath: '',
  fallbackPath: '',
  fullWidth: false,
