        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _index.FormGroup,
                    {
                        className: 'wfui-form-field ' + (descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description') + ' wfui-file-upload',
                        validationState: (touched || showErrors) && (error || globalError || fileError) ? 'error' : null
                    },
                    this.renderFile(),
...
renderFileUpload.propTypes = {
    ...
    isPublic: _propTypes2.default.bool
};
