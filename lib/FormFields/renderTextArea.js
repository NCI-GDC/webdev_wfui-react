...
var renderTextArea = function renderTextArea(_ref) {
  ...
  return preview ? React.createElement(Form.Row, {
  ...
  }, "".concat(input && input.value ? input.value.length : 0, " / ").concat(textLimit, " characters")) : null), (touched || showErrors) && globalError && React.createElement(Form.Control.Feedback, {
    className: "wfui-form-error",
    type: "invalid"
    ...
    className: "wfui-form-char-count"
  }, "".concat(input && input.value ? input.value.length : 0, " / ").concat(textLimit, " characters")) : null), !((touched || showErrors) && (error || globalError)) && textLimit && !preview ? React.createElement("span", {
    className: "wfui-form-char-count text-muted"
  }, "".concat(input && input.value ? input.value.length : 0, " / ").concat(textLimit, " characters")) : null, (touched || showErrors) && data && data.warning && React.createElement(Form.Control.Feedback, {
