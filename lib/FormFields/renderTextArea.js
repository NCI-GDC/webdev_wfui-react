...
var renderTextArea = function renderTextArea(_ref) {
  ...
  return preview ? React.createElement(Form.Row, {
  ...
  })), React.createElement(FormControl.Feedback, null), touched && error && React.createElement(Form.Control.Feedback, {
    ...
    type: "valid"
  }, React.createElement("span", null, data.warning), textLimit && !preview ? React.createElement("span", {
    className: "wfui-form-char-count"
