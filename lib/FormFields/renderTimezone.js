...
var renderTimezone = function renderTimezone(_ref) {
  ...
  return React.createElement(Form.Row, {
    ...
    className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-time-zone") // validationState={(touched || showErrors) && error ? 'error' : null}
