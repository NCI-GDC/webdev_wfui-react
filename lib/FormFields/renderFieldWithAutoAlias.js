...
import { Form, FormFields, FormGroup, FormControl, ControlLabel, HelpBlock } from '../index';
  ...
  _createClass(renderFieldWithAutoAlias, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-input") // validationState={
      ...
      }, postfix), !disabled && this.renderAutoAlias(), (touched || showErrors) && error && React.createElement(Form.Control.Feedback, {
        ...
        className: "wfui-form-error",
        type: "invalid"
      }, React.createElement("span", null, Array.isArray(globalError) ? globalError.join(', ') : globalError)), (touched || showErrors) && data.warning && React.createElement(Form.Control.Feedback, {
