...
var renderSingleCheckbox = _index.FormFields.renderSingleCheckbox;
...
var renderFieldWithAutoAlias = function (_React$Component) {
    ...
    function renderFieldWithAutoAlias() {
        ...
        return _possibleConstructorReturn(this, (renderFieldWithAutoAlias.__proto__ || Object.getPrototypeOf(renderFieldWithAutoAlias)).apply(this, arguments));
    }
    ...
    _createClass(renderFieldWithAutoAlias, [{
        ...
        value: function renderAutoAlias() {
            var _props = this.props,
                ...
                autoAliasText = _props.autoAliasText;
...
renderFieldWithAutoAlias.propTypes = {
    autoAliasText: _propTypes2.default.string
};
