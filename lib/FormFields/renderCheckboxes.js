...
var renderCheckboxes = function renderCheckboxes(_ref) {
  ...
  return React.createElement(Form.Row, {
    ...
    className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-checkboxes") // validationState={(touched || showErrors) && (error || globalError) ? 'error' : null}
