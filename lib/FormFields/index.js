...
var renderField = exports.renderField = function renderField(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)(className, 'wfui-form-item', { 'wfui-form-item-error': error }, { 'wfui-form-inline': inline }, { answered: input.value }) },
...
var renderTextArea = exports.renderTextArea = function renderTextArea(_ref2) {
    ...
    return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)(className, 'wfui-form-item', { 'wfui-form-item-error': error }, { answered: input.value }) },
        _react2.default.createElement(
            _index.ControlLabel,
            null,
            label
