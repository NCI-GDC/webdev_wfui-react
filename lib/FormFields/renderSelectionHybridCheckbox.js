...
var renderSelectionHybridCheckbox = function (_React$Component) {
    ...
    _createClass(renderSelectionHybridCheckbox, [{
        ...
        value: function onHandleChange(values, checkedValue) {
            ...
            var checkboxCid = fieldMap._checkbox.cid;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _index.FormGroup,
                    {
                        className: 'wfui-form-field ' + (descDisplay ? 'wfui-form-field-with-desctipton' : 'wfui-form-field-no-desctipton') + ' wfui-checkboxes-hybrid column-count-' + columnCount,
