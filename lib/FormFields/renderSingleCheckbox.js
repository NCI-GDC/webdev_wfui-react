...
var renderSingleCheckbox = function renderSingleCheckbox(_ref) {
  ...
  return React.createElement(Form.Row, {
    ...
    type: "checkbox",
    className: "wfui-form-checkbox-container".concat(input.checked ? ' active' : '').concat(disabled ? ' disabled' : '').concat(preview ? ' preview' : '')
    ...
    type: "invalid"
  }, React.createElement("span", null, error)), touched && data.warning && React.createElement(Form.Control.Feedback, {
    className: "wfui-form-warning",
    type: "valid"
  }, React.createElement("span", null, data.warning)), touched && globalError && React.createElement(Form.Control.Feedback, {
    className: "wfui-form-error",
    type: "invalid"
