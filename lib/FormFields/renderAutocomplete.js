  ...
  _createClass(renderAutocomplete, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        type: "invalid"
      }, React.createElement("span", null, Array.isArray(error) ? error.join(', ') : error)), touched && data.warning && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-warning",
        type: "valid"
      }, React.createElement("span", null, Array.isArray(data.warning) ? data.warning.join(', ') : data.warning)), touched && globalError && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error",
        type: "invalid"
