...
import { Spinner, FormGroup, FormControl, Form, ControlLabel, HelpBlock } from '../index';
  ...
  _createClass(renderAutocomplete, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "wfui-form-input wfui-form-autocomplete" // validationState={
        ...
        className: "wfui-form-error",
        type: "invalid"
      }, React.createElement("span", null, Array.isArray(globalError) ? globalError.join(', ') : globalError)), help && React.createElement("div", {
