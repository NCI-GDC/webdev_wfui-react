...
var renderField = function renderField(_ref) {
  ...
  return React.createElement(Form.Row, {
    ...
    className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-input") // validationState={(touched || showErrors) && (error || globalError) ? 'error' : null}
  ...
  }, postfix), React.createElement(FormControl.Feedback, null), (touched || showErrors) && error && React.createElement(Form.Control.Feedback, {
