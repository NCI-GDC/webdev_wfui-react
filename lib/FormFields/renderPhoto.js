...
function (_React$Component) {
  ...
  _createClass(renderPhoto, [{
    ...
    value: function render() {
      ...
      }), "Choose File")), touched && error && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error",
        type: "invalid"
      }, React.createElement("span", null, Array.isArray(error) ? error.join(', ') : error)), touched && globalError && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error",
        type: "invalid"
