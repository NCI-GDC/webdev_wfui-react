  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      return React.createElement(Form.Row, {
        ...
        className: "span-plus"
      }, labelAddAnother))), touched && data.warning && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-warning",
        type: "valid"
      }, React.createElement("span", null, data.warning)), (this.touched || submitFailed) && globalError && React.createElement(Form.Control.Feedback, {
