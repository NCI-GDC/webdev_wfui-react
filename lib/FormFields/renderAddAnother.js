    ...
    value: function render() {
      ...
      return React.createElement(Form.Row, {
        className: classNames(className, 'wfui-form-item', {
          ...
          'wfui-form-item-warning': this.touched && data && data.warning
        }, {
        ...
        className: classNames('d-none', 'custom-form-control', {
          'is-valid-warning': this.touched && data && data.warning
        })
        ...
        className: "span-plus"
      }, labelAddAnother)))), (this.touched || submitFailed) && globalError && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error"
      }, React.createElement("span", null, Array.isArray(globalError) ? globalError.join(', ') : globalError)), this.touched && data && data.warning && React.createElement(Form.Control.Feedback, {
