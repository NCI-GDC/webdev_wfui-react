...
import { Draggable, DraggableWithContext, Button, Form, Col, Row, FormGroup, ControlLabel, HelpBlock, Icon, FormControl } from '../index';
  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          maximumItem = _this$props2.maximumItem;
      ...
      return React.createElement(Form.Row, {
        className: classNames(className, 'wfui-form-item', {
          'wfui-form-item-error': (this.touched || showErrors) && globalError
        }, {
          'wfui-form-item-warning': (this.touched || showErrors) && data && data.warning
        }, {
        ...
        as: Col,
        xs: 12,
        lg: inline && label ? descDisplay && !preview ? 4 : 10 : descDisplay && !preview ? 6 : 9,
        ...
        return React.createElement("div", {
          ...
          className: "wfui-form-addAnother-content"
        }, childComponent(field, i)), React.createElement("div", {
          className: "wfui-form-addAnother-delete"
        }, React.createElement(DeleteButton, {
          type: "DeleteButton",
          index: i
        })));
      }), !disabled && (!maximumItem || maximumItem > fields.length) && React.createElement("div", {
        className: "wfui-form-addAnother-btn-container"
        ...
        plus: true
      }, React.createElement("span", null, labelAddAnother)))), (this.touched || showErrors || submitFailed) && globalError && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error",
        type: "invalid"
      }, React.createElement("span", null, Array.isArray(globalError) ? globalError.join(', ') : globalError)), (this.touched || showErrors) && data && data.warning && React.createElement(Form.Control.Feedback, {
