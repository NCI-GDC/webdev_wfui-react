...
import { Draggable, DraggableWithContext, Button, FormGroup, ControlLabel, HelpBlock, Glyphicon, Icon } from '../index';
  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "span-plus"
      }, labelAddAnother)), error && React.createElement(HelpBlock, {
        className: "wfui-form-error"
      }, React.createElement("span", null, error)), (this.touched || submitFailed) && globalError && React.createElement(HelpBlock, {
        className: "wfui-form-error"
