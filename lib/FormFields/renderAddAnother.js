...
import { Draggable, DraggableWithContext, Button, Form, Col, Row, FormGroup, ControlLabel, HelpBlock, Glyphicon, Icon } from '../index';
  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      return React.createElement(Form.Row, {
        ...
        as: Col,
        xs: 12,
        md: inline && label ? descDisplay && !preview ? 4 : 10 : descDisplay && !preview ? 6 : 9,
        ...
        className: "span-plus"
      }, labelAddAnother))), error && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error"
      }, React.createElement("span", null, error)), (this.touched || submitFailed) && globalError && React.createElement(Form.Control.Feedback, {
        className: "wfui-form-error"
