  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      return React.createElement(Form.Row, {
        ...
        className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-addAnother") // validationState={
        ...
        className: "span-plus"
      }, labelAddAnother)))), (this.touched || showErrors || submitFailed) && globalError && React.createElement(Form.Control.Feedback, {
