...
function (_React$Component) {
  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      }, React.createElement("span", null, Array.isArray(globalError) ? globalError.join(', ') : globalError)), this.touched && data.warning && React.createElement(Form.Control.Feedback, {
