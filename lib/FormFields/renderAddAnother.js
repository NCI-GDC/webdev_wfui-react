...
import { Draggable, DraggableWithContext, Button, Form, Col, Row, FormGroup, ControlLabel, HelpBlock, Icon } from '../index';
  ...
  _createClass(renderAddAnother, [{
    ...
    value: function render() {
      ...
      return React.createElement(Form.Row, {
        ...
        type: "valid"
      }, React.createElement("span", null, Array.isArray(data.warning) ? data.warning.join(', ') : data.warning)), help && !preview && React.createElement("div", {
