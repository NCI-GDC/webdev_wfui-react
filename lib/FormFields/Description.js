...
function (_Component) {
  ...
  _createClass(Description, [{
    ...
    value: function render() {
      ...
      var containerClassName = 'wfui-description wfui-description--' + type + errorClassName + ' ' + classNames; //based off of adding the dialog to the <body> tag,
      ...
      } else if (_typeof(content) == 'object' && src) {
        return React.createElement("div", {
          className: containerClassName
        }, React.createElement("div", {
          className: "wfui-description__textContainer"
