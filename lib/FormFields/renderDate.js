...
var renderDate = function renderDate(_ref) {
  ...
  return React.createElement(Form.Row, {
    ...
    className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-form-date ").concat((touched || showErrors) && (error || globalError) ? 'wfui-form-with-error' : ''),
