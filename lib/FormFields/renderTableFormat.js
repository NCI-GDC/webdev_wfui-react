    ...
    _createClass(renderTableFormat, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                {
                    className: (0, _classnames2.default)(className, 'wfui-form-item', { 'wfui-form-item-error': (allTouched || showErrors) && globalError }, { 'wfui-form-disabled': disabled }, { 'wfui-form-preview': preview })
                },
                ...
                _react2.default.createElement(
                    _index.FormGroup,
                    {
                        className: 'wfui-form-field ' + (descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description') + ' wfui-table-format multiple-inputs-' + Object.keys(fieldMap).length,
