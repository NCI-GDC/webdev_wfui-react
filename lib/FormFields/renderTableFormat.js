  ...
  _createClass(renderTableFormat, [{
    ...
    value: function render() {
      ...
      return React.createElement(Form.Row, {
        ...
        className: "wfui-form-field ".concat(descDisplay ? 'wfui-form-field-with-description' : 'wfui-form-field-no-description', " wfui-table-format multiple-inputs-").concat(Object.keys(fieldMap).length) // validationState={(allTouched || showErrors) && globalError ? 'error' : null}
        ...
        return lists;
      })), (allTouched || showErrors) && globalError && React.createElement(Form.Control.Feedback, {
