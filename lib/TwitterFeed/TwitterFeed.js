...
function (_React$Component) {
  ...
  function TwitterFeed(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TwitterFeed).call(this, props));
  }
  ...
  _createClass(TwitterFeed, [{
    ...
    value: function render() {
      var _this$props = this.props,
          twitterAccount = _this$props.twitterAccount,
          limit = _this$props.limit,
          width = _this$props.width,
          height = _this$props.height,
          language = _this$props.language;
      var urlSafeTwitter = encodeURIComponent(twitterAccount);
      var twitterLink = "https://twitter.com/".concat(urlSafeTwitter);
