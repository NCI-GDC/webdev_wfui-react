...
var DraggableItem = (_dec = (0, _reactDnd.DropTarget)(_ItemTypes2.default.Item, itemTarget, function (connect) {
    ...
    _createClass(DraggableItem, [{
        ...
        key: 'checkHasHandle',
        value: function checkHasHandle(props) {
            var _this2 = this;

            var children = props.children.props.children;

            if ((typeof children === 'undefined' ? 'undefined' : _typeof(children)) === 'object' && children.length) {
        ...
        value: function render() {
            ...
            if (hasHandle) {
                return connectDragPreview(connectDropTarget(_react2.default.createElement(
                    ...
                    (typeof children === 'undefined' ? 'undefined' : _typeof(children)) === 'object' ? children.map(function (child, i) {
                        if (child.type == _DraggableHandle2.default) {
