...
function (_Component) {
  ...
  _createClass(Description, [{
    ...
    value: function render() {
      ...
      var containerClassName = "wfui-description wfui-description--".concat(type).concat(errorClassName, " ").concat(classNames); // based off of adding the dialog to the <body> tag,
