...
var Search = {
   search: function search(data, searchTerm) {
      ...
      function tokenize() {
         ...
         var fieldsRegularExpression = /\b\w*:"\w*"/;
         ...
         if (fieldsRegularExpressionResults) {
            ...
            try {
               for (var _iterator3 = fieldsRegularExpressionResults[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
         ...
         if (stringTokens) {
            ...
            try {
               for (var _iterator4 = stringTokens[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                  var s = _step4.value;
