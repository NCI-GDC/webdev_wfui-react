                ...
                if (response.ok) {
                    ...
                    if (contentType && contentType.indexOf('application/json') !== -1) {
                        return response.json().then(function (data) {
                            dispatch({ type: 'RECEIVE_FETCH_DATA', requestId: init.requestId, appId: appId, data: data });
                            dispatch({ type: 'FETCH_SUCCESS', requestId: init.requestId, appId: appId, data: data });
                    ...
                    response.text().then(function (data) {
                        ...
                        dispatch({ type: 'FETCH_FAILURE', requestId: init.requestId, statusText: statusText, appId: appId });
                    });
                }
