...
var UserDrawer = function (_Component) {
    ...
    _createClass(UserDrawer, [{
        ...
        value: function renderUserInfo() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'user-drawer-info' },
                _react2.default.createElement(
                    'div',
                    { className: 'col-xs-3', style: { minWidth: '40px', minHeight: '40px', padding: '0' } },
                    _react2.default.createElement('img', { width: 40, height: 40, src: userInfo.image })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'col-xs-9' },
