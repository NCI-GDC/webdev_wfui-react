  ...
  _createClass(FilteredList, [{
    ...
    value: function applySearch(articles) {
      var _this$props = this.props,
          ...
          simpleSearch = _this$props.simpleSearch,
          searchKeys = _this$props.searchKeys,
          wholeWord = _this$props.wholeWord,
          searchLogic = _this$props.searchLogic;
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          itemDisplay = _this$props3.itemDisplay,
          paginatorDisplay = _this$props3.paginatorDisplay,
          data = _this$props3.data,
          pageSize = _this$props3.pageSize,
          sortFunction = _this$props3.sortFunction,
          container = _this$props3.container,
          onDisplay = _this$props3.onDisplay,
          onNumOfListChange = _this$props3.onNumOfListChange,
          onListDidMount = _this$props3.onListDidMount,
          noWrapper = _this$props3.noWrapper;
      var currentPage = this.state.currentPage;
      var filteredData = this.applySearch(this.generateFilteredArticles(data));
