...
var List = function (_React$Component) {
    ...
    _createClass(List, [{
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            if (activeData.length !== this.state.numOfItems || startingArticle !== this.state.startingArticle || lastArticle !== this.state.lastArticle || prevProps.data.length !== data.length || JSON.stringify(prevProps.data) !== JSON.stringify(data)) {
                this.updateStatus();
            }
        }
    }, {
