  ...
  _createClass(ModalDialog, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          btnCancelStyle = _this$props5.btnCancelStyle,
      ...
      }))), React.createElement(Modal.Footer, null, notForm ? React.createElement(React.Fragment, null, React.createElement(Button, {
        variant: btnCancelStyle || 'outline-primary',
        className: "text-uppercase",
        onClick: this.onHandleCancel
      }, txtCancel)) : React.createElement(React.Fragment, null, React.createElement(Button, {
        type: "submit",
