                        ...
                        if (newFetches[key].status === 'success') {
                            if (level.includes('success')) {
                                _this5.notificationRef.addNotification({
                                    children: overriding.success ? _react2.default.createElement(_reactIntl.FormattedHTMLMessage, {
                                        id: '_overridding_text_',
                                        defaultMessage: overriding.success,
                                        values: Object.assign({}, (0, _flattenObject.flattenObject)(fetches[key].meta), (0, _flattenObject.flattenObject)(values), (0, _flattenObject.flattenObject)(newFetches[key].data), { lang: lang })
                            ...
                            if (_typeof(newFetches[key].error) === 'object') {
                                _this5.notificationRef.addNotification({
                                    children: overriding.error && overriding.error[newFetches[key].error.type] ? _react2.default.createElement(_reactIntl.FormattedHTMLMessage, {
                                        id: '_overridding_text_',
                                        defaultMessage: overriding.error[newFetches[key].error.type],
                                        values: Object.assign({}, (0, _flattenObject.flattenObject)(fetches[key].meta), (0, _flattenObject.flattenObject)(values), (0, _flattenObject.flattenObject)(newFetches[key].data), { lang: lang })
                                    }) : _react2.default.createElement(_reactIntl.FormattedHTMLMessage, {
                                        id: 'notifications.' + notificationId + '.error.' + newFetches[key].error.type,
                                        values: Object.assign({}, (0, _flattenObject.flattenObject)(fetches[key].meta), (0, _flattenObject.flattenObject)(values), (0, _flattenObject.flattenObject)(newFetches[key].data), { lang: lang })
                                    }),
                                    level: 'error',
                                    autoDismiss: Math.floor(duration / 1000)
                                ...
                                _this5.notificationRef.addNotification({
                                    children: overriding.error && overriding.error.default ? _react2.default.createElement(_reactIntl.FormattedHTMLMessage, {
                                        id: '_overridding_text_',
                                        defaultMessage: overriding.error.default,
                                        values: Object.assign({}, (0, _flattenObject.flattenObject)(fetches[key].meta), (0, _flattenObject.flattenObject)(values), {
