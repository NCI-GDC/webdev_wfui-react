...
function (_React$Component) {
  ...
  _createClass(StaticNotification, [{
    ...
    value: function render() {
      ...
      var notifications = this.state.notifications;
      return notifications && notifications.length ? React.createElement("div", {
...
function (_React$Component2) {
  ...
  _createClass(Notifications, [{
          ...
          if (fetches[key].isFetching && !newFetches[key].isFetching) {
            ...
            if (newFetches[key].status === 'success') {
              ...
              if (_typeof(newFetches[key].error) === 'object') {
                ...
                displayingDefaultMessage = overriding.error && overriding.error[newFetches[key].error.type] || "An unexpected error has occurred.<br/> Error: \"".concat(newFetches[key].error.type, "\"");
                ...
                var errorData = newFetches[key].error.data || {};
                displayingValues = flattenObject.apply(void 0, _toConsumableArray(newFetches[key].data).concat(_toConsumableArray(errorData)));
              } else {
                displayingLevel = 'error';
    ...
    value: function componentWillMount() {
      ...
      var el = document.getElementById('wfui-notifications');
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        withTitle: true
      }) : ReactDOM.createPortal(React.createElement(NotificationSystem, {
        ref: function ref(_ref2) {
          _this5.notificationRef = _ref2;
          notificationRef(_ref2);
        },
        withTitle: true
      }), document.querySelector('#wfui-notifications')));
    }
  }]);
