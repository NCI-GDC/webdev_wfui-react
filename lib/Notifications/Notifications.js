                    ...
                    if (fetches[key].isFetching && !newFetches[key].isFetching) {
                        ...
                        if (newFetches[key].status === 'success') {
                            ...
                            if (_typeof(newFetches[key].error) === 'object') {
                                ...
                                displayingDefaultMessage = overriding.error && overriding.error[newFetches[key].error.type] || 'An unexpected error has occurred.<br/> Error: "' + newFetches[key].error.type + '"';
