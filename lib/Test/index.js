...
req.keys().forEach(function (filePath) {
    ...
    var matchFilenameBody = /^.*\/(.*)\/(.*)\.jsx?$[^.]*$/g;
    var match = matchFilenameBody.exec(filePath);
    var ver = match['1'];
    var filenameBody = match['2'];
...
var Wrapper = function (_Component) {
    ...
    _createClass(Wrapper, [{
        ...
        value: function render() {
            ...
            var latest = Object.keys(versions)[Object.keys(versions).length - 1];
            var Comp = versions[ver || latest].default;
            if (!Comp) {
