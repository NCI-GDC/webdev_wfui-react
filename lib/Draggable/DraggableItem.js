        ...
        value: function render() {
            ...
            if (hasHandle) {
                return connectDragPreview(connectDropTarget(_react2.default.createElement(
                    'li',
                    { id: id, className: (0, _classnames2.default)(className, classes), style: { opacity: opacity, breakInside: 'avoid', pageBreakInside: 'avoid' } },
                    children.map(function (child, i) {
                        ...
                        return _react2.default.createElement(
                            'div',
                            { className: 'wfui-draggable-content', key: i },
                            child
                        );
                    })
                )));
