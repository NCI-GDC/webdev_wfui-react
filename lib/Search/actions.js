...
export var getAutocomplete = function getAutocomplete(config, _ref) {
  var _ref$keyword = _ref.keyword,
      keyword = _ref$keyword === void 0 ? '' : _ref$keyword,
      _ref$typeInclude = _ref.typeInclude,
      typeInclude = _ref$typeInclude === void 0 ? [] : _ref$typeInclude;
  return function (dispatch) {
    var req = wfuiFetch("//".concat(config.API_HOST || 'localhost').concat(config.API_SEARCH || '/content/search'), {
      method: 'POST',
      headers: {
...
export var getSearchResult = function getSearchResult(config, _ref3) {
  var _ref3$keyword = _ref3.keyword,
      keyword = _ref3$keyword === void 0 ? '' : _ref3$keyword,
      _ref3$typeInclude = _ref3.typeInclude,
      typeInclude = _ref3$typeInclude === void 0 ? [] : _ref3$typeInclude,
      _ref3$keywordQuotes = _ref3.keywordQuotes,
      keywordQuotes = _ref3$keywordQuotes === void 0 ? false : _ref3$keywordQuotes;
  return function (dispatch) {
