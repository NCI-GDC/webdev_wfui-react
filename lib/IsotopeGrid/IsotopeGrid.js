...
function (_React$Component) {
  ...
  _createClass(IsotopeGrid, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (typeof this.props.searchTerm === 'string' && this.props.searchTerm.toLowerCase().trim() !== nextProps.searchTerm.toLowerCase().trim() || JSON.stringify(this.props.filterList) !== JSON.stringify(nextProps.filterList) || JSON.stringify(this.props.category) !== JSON.stringify(nextProps.category)) {
