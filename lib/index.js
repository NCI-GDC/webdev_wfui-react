...
Object.keys(_reactMarkdown).forEach(function (key) {
    if (key === "default" || key === "__esModule") return;
    Object.defineProperty(exports, key, {
        enumerable: true,
        get: function get() {
            return _reactMarkdown[key];
        }
    });
});
...
var _FilterTool = require('./FilterTool/FilterTool');

var _FilterTool2 = _interopRequireDefault(_FilterTool);
...
exports.FilterTool = _FilterTool2.default;