...
exports.validateConfirmPasswords = exports.validateAtLeastOneNumber = exports.validateAtLeastOneUpper = exports.validateAtLeastOneLower = exports.validateCharacterLength = undefined;
...
var validateCharacterLength = exports.validateCharacterLength = function validateCharacterLength(password) {
 ...
 */
var validateAtLeastOneLower = exports.validateAtLeastOneLower = function validateAtLeastOneLower(password) {
 ...
 * Check if a password contains both upper and lower case.
 */
var validateAtLeastOneUpper = exports.validateAtLeastOneUpper = function validateAtLeastOneUpper(password) {
 ...
 */
var validateAtLeastOneNumber = exports.validateAtLeastOneNumber = function validateAtLeastOneNumber(password) {
 ...
 */
var validateConfirmPasswords = exports.validateConfirmPasswords = function validateConfirmPasswords(password, passwordConfirm) {
    ...
    _createClass(PasswordValidator, [{
        ...
        value: function componentDidUpdate() {
            var _props = this.props,
                ...
                validateWith = _props.validateWith;
        ...
        value: function render() {
            var _props2 = this.props,
                ...
                validateWith = _props2.validateWith;
                    ...
                    validations.filter(function (validation) {
                        ...
                        return _react2.default.createElement(
                            'li',
                            {
                                ...
                                style: validated ? _style2.default.li_active : _style2.default.li
                            },
                            validated ? _react2.default.createElement(_reactBootstrap.Glyphicon, {
                                glyph: 'ok',
