...
var TITLE_ROLE = DashboardCardTitle.defaultProps.role;
var HEADER_ROLE = DashboardCardHeader.defaultProps.role;
  ...
  _createClass(DashboardCard, [{
    ...
    value: function render() {
      ...
      return React.createElement(Card, {
        className: classNames(className, 'form-box-container'),
        cardStyle: style
