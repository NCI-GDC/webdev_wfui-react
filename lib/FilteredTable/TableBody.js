    ...
    _createClass(TableBody, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rowClickable = _props.rowClickable,
            ...
            var itemDisplays = activeData.map(function (item, idx) {
                ...
                if (rowClickable) {
                    itemFormat.forEach(function (cell, rowIdx) {
                        if (cell.excludeRowClick) {
                            ...
                            rowItems.push(_react2.default.createElement(
                                'td',
                                { key: 'td_' + idx + '_' + rowIdx, className: cell.className, onClick: function onClick() {
                ...
                return _react2.default.createElement(
                    'tr',
                    { key: 'td_' + idx, className: ((idx + 1) % 2 === 0 ? 'even' : 'odd') + ' ' + item.className },
                    rowItems
                );
            });
