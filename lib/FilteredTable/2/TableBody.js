    ...
    _createClass(TableBody, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                columnResizeDisabled = _props.columnResizeDisabled;
            ...
            return _react2.default.createElement(
                _fixedDataTable.Table,
                {
                    ...
                    rowHeightGetter: function rowHeightGetter(idx) {
                        var rows = document.getElementsByClassName('public_fixedDataTable_bodyRow');
                        if (rows && rows[idx]) {
