  ...
  _createClass(FilteredTable, [{
    ...
    value: function applySearch(articles) {
      var _this$props3 = this.props,
          ...
          exclProps = _this$props3.exclProps;

      if (searchTerm) {
        var filteredArticles = simpleSearch ? Search.simpleSearch(articles, searchTerm, searchKeys, wholeWord, searchLogic, true, exclProps) : Search.search(articles, searchTerm, exclProps);
        return filteredArticles;
      }
