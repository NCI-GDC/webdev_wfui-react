    ...
    _createClass(FilteredTable, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if (thisData.length !== nextData.length) {
                this.setState({
                    dataWithState: nextData.map(function (obj, i) {
        ...
        value: function applySearch(articles) {
            ...
            if (searchTerm) {
                var filteredArticles = simpleSearch ? _searchUtil2.default.simpleSearch(articles, searchTerm, searchKeys, wholeWord) : _searchUtil2.default.search(articles, searchTerm);
                return filteredArticles;
            }
