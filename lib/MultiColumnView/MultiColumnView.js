    ...
    value: function render() {
      ...
      if (enableResize) {
        return React.createElement("div", {
          id: id,
          className: classNames('multi-column-view multi-column-resize-view three-column-view three-column-resize-view', className, "".concat(visibleColCount, "-column-visible"), "".concat(displayChild.map(function (c) {
            return "".concat(c.props.className, "-visible");
          }).join(' ')))
      ...
      return React.createElement("div", {
        id: id,
        className: classNames('multi-column-view multi-column-noresize-view three-column-view three-column-noresize-view', className, "".concat(visibleColCount, "-column-visible"), "".concat(displayChild.map(function (c) {
          return "".concat(c.props.className, "-visible");
        }).join(' ')))
      }, React.cloneElement(displayChild[0], {
        key: 1
